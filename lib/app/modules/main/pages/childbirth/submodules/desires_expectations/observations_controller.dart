...
/// Controlador de OBSERVAÇÕES (seção do Plano de Parto) — API como fonte.
abstract class ObservationsControllerBase with Store {
  final PlanoPartoRepository planoPartoRepository;
  final PerfilRepository perfilRepository;

  ObservationsControllerBase(this.planoPartoRepository, this.perfilRepository);
  ...
  @action
  Future<void> saveObservations({required String observacoes}) async {
    if (_busy) return;
    final gid = _gestacaoId;
    if (gid == null) {
