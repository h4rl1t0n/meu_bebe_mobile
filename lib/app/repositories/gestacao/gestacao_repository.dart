...
abstract class GestacaoRepository {
  Future<Result<GestacaoModel, BackendFailure>> createGestacao(GestacaoModel gestacao);

  Future<Result<GestacaoModel, BackendFailure>> updateGestacao(GestacaoModel gestacao);
}
